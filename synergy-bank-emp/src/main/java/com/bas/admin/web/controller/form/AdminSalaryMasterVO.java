 ...
 *
 */
public class AdminSalaryMasterVO {
	private int eid;
	private String name;
	...
	public AdminSalaryMasterVO(int eid, String name, String category,
	...
	public String toString() {
		return "AdminSalaryMasterVO [eid=" + eid + ", name=" + name
