 ...
 * 
 */
public class ManualAttendanceEntity {
    ...
    public String toString() {
        return "ManualAttendanceEntity{" + "eid=" + eid + ", name=" + name + ", department=" + department + ", designation=" + designation + ", type=" + type + ", cdate=" + cdate + ", detail=" + detail + ", intime=" + intime + ", intimestatus=" + intimestatus + ", outtime=" + outtime + ", outtimestatus=" + outtimestatus + ", present=" + present + '}';
    }
