    ...
    <section id="portfolio" class="container main">    
        <ul class="gallery col-4">
            ...
            <li>
                ...
                <div class="desc">
                   <a href="${pageContext.request.contextPath}/employee/DisplayGalleryPhotos"><h5>Annual function</h5></a>
...
<nav>
  <ul class="pager">
    ...
    <li class="next"><a href="${pageContext.request.contextPath}/Portfolio2.jsp">Newer <span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
    <!--Bottom-->
