...
<br><br><br>
<section id="portfolios" class="container main">    
          <ul class="gallery col-4">
  
	<form action="" method="post" enctype="multipart/form-data">
  	<!-- <table border="0"  cellpadding="20px" >  -->
	<ul class="gallery col-4"> 
	<p:forEach items="${photoIds}" var="photoId">
	<li>
		<div class="preview">					
			<img alt="" src="${pageContext.request.contextPath}/employee/findPhotoById?pid=${photoId}" width="200" height="200" class="img-rounded"/>
		</div>
	</li>
	</p:forEach>
	</ul>
