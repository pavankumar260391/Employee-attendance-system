					...
					<fieldset>
						...
						<table width="630" border="0" align="left">
							...
							<!-- <tr bgcolor="#66CCFF" style="color: #000000; font-weight: bold;">
								...
								<td colspan="2"><span style="color: red;font-weight: bold;font-size: 14px;" id="errorMessage">${error}</span></td>
							</tr>		
							...
							<tr  style="color: #000000; font-weight: bold;">
							 ...
							 <tr bgcolor="white" style="color: #000000; font-weight: bold;">
								<td>
								<input type="button" id="login" class="btn btn-info" size="30" value="Log-in" ></input>
								</td>
								<td>
