    ...
    <section id="portfolio" class="container main">    
        <ul class="gallery col-4">
            ...
            <li>
                ...
                <div class="desc">
                   <a href="${pageContext.request.contextPath}/employee/findPhotoById?pid=1"><h5>Annual function</h5></a>
...
<nav>
  <ul class="pager">
    <li class="previous"><a href="${pageContext.request.contextPath}/portfolio.jsp"><span aria-hidden="true">&larr;</span> Older</a></li>
